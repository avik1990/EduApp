...
public class FileUploadResponse {
    ...
    public class Dataum {
        ...
        public List<FileUploadResponse.UploadedFileName> getUploadedFileName() {
            return UploadedFileName;
        }

        public void setUploadedFileName(List<FileUploadResponse.UploadedFileName> uploadedFileName) {
