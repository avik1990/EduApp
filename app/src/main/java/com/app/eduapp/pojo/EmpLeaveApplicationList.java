...
public class EmpLeaveApplicationList extends BaseObservable {
    ...
    public class Data {
        @SerializedName("EmployeeLeaveApplicationList")
        @Expose
        public List<StudentLeaveApplicationList> StudentLeaveApplicationList;

        public List<EmpLeaveApplicationList.StudentLeaveApplicationList> getStudentLeaveApplicationList() {
            return StudentLeaveApplicationList;
        }

        public void setStudentLeaveApplicationList(List<EmpLeaveApplicationList.StudentLeaveApplicationList> studentLeaveApplicationList) {
