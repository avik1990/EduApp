...
import com.app.eduapp.adapter.AMonthListApapter;
...
public class AMonthListActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {

    MonthlistActivityIncBinding binding;
    Context mContext;
    ConnectionDetector cd;
    AMonthListApapter monthListApapter;
    ProgressDialog pDialog;
    Months getMonthsList;
    String studentname, classname, studentid;
    ...
    private void setuplistview() {
        if (getMonthsList.getData().getMonthsList().size() > 0) {
            binding.monthlistActivity.tvSectionname.setVisibility(View.VISIBLE);
            binding.monthlistActivity.tvSectionname.setText(classname);
            binding.monthlistActivity.tvMonth.setBackgroundColor(Color.parseColor("#20e7fe"));
            binding.monthlistActivity.tvMonth.setTextColor(Color.parseColor("#000000"));
            binding.monthlistActivity.tvMonth.setText(studentname);
            monthListApapter = new AMonthListApapter(mContext, R.layout.row_monthlist, getMonthsList.getData().getMonthsList(), "MonthListActivity", studentid);
