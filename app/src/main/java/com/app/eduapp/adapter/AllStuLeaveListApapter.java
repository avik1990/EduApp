...
public class AllStuLeaveListApapter extends RecyclerView.Adapter<AllStuLeaveListApapter.VHItem> {
    private Context mContext;
    private int rowLayout;
    ConnectionDetector cd;
    private List<AllLeaveApplicationListEMP.StudentLeaveApplicationList> dataMembers;

    public AllStuLeaveListApapter(Context context, int rowLayout, List<AllLeaveApplicationListEMP.StudentLeaveApplicationList> members, String flag) {
    ...
    @Override
    public AllStuLeaveListApapter.VHItem onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new AllStuLeaveListApapter.VHItem(v);
    }
