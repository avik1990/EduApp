...
public class MyLeaveListApapter extends RecyclerView.Adapter<MyLeaveListApapter.VHItem> {
    private Context mContext;
    private int rowLayout;
    ConnectionDetector cd;
    private List<MyLeaveApplicationListEMP.MyLeaveApplicationList> dataMembers;

    public MyLeaveListApapter(Context context, int rowLayout, List<MyLeaveApplicationListEMP.MyLeaveApplicationList> members, String flag) {
    ...
    @Override
    public MyLeaveListApapter.VHItem onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new MyLeaveListApapter.VHItem(v);
    }
