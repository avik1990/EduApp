...
public class StudentLeaveListApapter extends RecyclerView.Adapter<StudentLeaveListApapter.VHItem> {
    private Context mContext;
    private int rowLayout;
    ConnectionDetector cd;
    private List<StudentLeave.LeaveList> dataMembers;

    public StudentLeaveListApapter(Context context, int rowLayout, List<StudentLeave.LeaveList> members, String flag) {
    ...
    @Override
    public StudentLeaveListApapter.VHItem onCreateViewHolder(ViewGroup viewGroup, int viewType) {
        View v = LayoutInflater.from(viewGroup.getContext()).inflate(rowLayout, viewGroup, false);
        return new StudentLeaveListApapter.VHItem(v);
    }
