...
class GroupParentHolder extends ParentViewHolder {
    ...
    public GroupParentHolder(@NonNull View itemView) {
        super(itemView);
    ...
    public void bind(@NonNull Notice.NoticeData recipe) {
        //mRecipeTextView.setText(recipe.getRoute_details().getKidpool_route_id());
        mRecipeTextView.setText(recipe.getNoticeDate());
        group_count.setText(recipe.getTotalNotice());
    }
