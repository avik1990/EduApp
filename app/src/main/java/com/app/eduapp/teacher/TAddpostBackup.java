...
public class TAddpostBackup extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener, View.OnClickListener {
    ...
    private boolean checkpermission() {
        ...
        if (ActivityCompat.checkSelfPermission(mContext, permissionsRequired[0]) != PackageManager.PERMISSION_GRANTED
            ...
            if (ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[0])
                    || ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[1])
                    || ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[2])
                    ) {
                ...
                builder.setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    ...
                    public void onClick(DialogInterface dialog, int which) {
                        dialog.cancel();
                        ActivityCompat.requestPermissions(TAddpostBackup.this, permissionsRequired, PERMISSION_CALLBACK_CONSTANT);
                    }
                });
    ...
    public void onRequestPermissionsResult(int requestCode, @NonNull String[] permissions, @NonNull int[] grantResults) {
        ...
        if (requestCode == PERMISSION_CALLBACK_CONSTANT) {
            ...
            if (allgranted) {
                opencamera();
            } else if (ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[0])
                    || ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[1])
                    || ActivityCompat.shouldShowRequestPermissionRationale(TAddpostBackup.this, permissionsRequired[2])) {
                AlertDialog.Builder builder = new AlertDialog.Builder(TAddpostBackup.this);
                builder.setTitle("Need Multiple Permissions");
                builder.setMessage("This app needs Camera and Storage permissions.");
                builder.setPositiveButton("Allow", new DialogInterface.OnClickListener() {
                    @Override
